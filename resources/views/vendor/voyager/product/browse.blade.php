@extends('voyager::vendor.tcg.voyager.resources.views.master')
...
@section('content')
    @include('voyager::vendor.tcg.voyager.resources.views.menus.partial.notice')

    <div class="page-content container-fluid">
        @include('voyager::vendor.tcg.voyager.resources.views.alerts')
        <div class="row">
            <div class="col-md-12">
